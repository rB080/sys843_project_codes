...
from .bases import BaseImageDataset #needs relative import in a non debug modes
...
class MSMT17(BaseImageDataset):
    ...
    def _process_dir(self, dir_path, list_path, exclude_after=-1):
        ...
        for img_idx, img_info in enumerate(lines):
            ...
            if exclude_after != -1: # added exclusion pids
                if pid > exclude_after: continue
...
#     ds = MSMT17('/export/livia/home/vision/Rbhattacharya/work/data/data/msmt17/')
#     breakpoint()